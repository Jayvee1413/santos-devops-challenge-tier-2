...
def generate_pipeline_policy(scope):
    return iam.Policy(scope=scope,
                      id="JVSANTOSTier2PipelinePolicy",
...
def generate_codebuild_policy(scope, db_secret_arn):
    return iam.Policy(scope=scope,
                      id="JVSANTOSTier2CodebuildPolicy",
...
def generate_ecs_task_policy(scope):
    return iam.Policy(scope=scope,
                      id="JVSANTOSTier2ECSTaskPolicy",
                      policy_name="JVSANTOS-ecs-task-policy",
                      statements=[
...
def generate_ecs_execution_policy(scope):
    return iam.Policy(scope=scope,
                      id="JVSANTOSTier2ECSExecutionPolicy",
                      policy_name="JVSANTOS-ecs-task-policy",
                      statements=[
